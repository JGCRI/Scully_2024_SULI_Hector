# Script for experiment 16
# Script to uses T, OHC and CO2 NMAEs while accounting for T, OHC unc
...
OUTPUT <- file.path(RESULTS_DIR, "16_alpha_ecs_ohc_unc_nmae.txt")
...
best_pars <- run_optim(obs_data = obs_data,
                       ...
                       error_fn = mean_T_CO2_OHC_nmae_unc,
                       include_unc = T,
                       method = "L-BFGS-B",
                       output_file = OUTPUT)
