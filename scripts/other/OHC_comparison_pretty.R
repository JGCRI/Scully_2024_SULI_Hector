...
# This script only makes an OHC plot
# However, since it's based on a script to plot both CO2 and T, it 
# may (inefficiently) also record T and CO2 data
# Author: Peter Scully
# Date: 7/1/24
...
OUTPUT <- file.path(RESULTS_DIR, "all_run_OHC_comparison.jpeg")
...
hector_data <- filter(hector_data, variable == "OHC")
