# Script to create all plots of historical data for SULI paper
# By: Peter Scully
# Date: 7/15/24
...
T_OUTPUT <- file.path(RESULTS_DIR, "SULI_paper_T_comparison.jpeg")
CO2_OUTPUT <- file.path(RESULTS_DIR, "SULI_paper_CO2_comparison.jpeg")
OHC_OUTPUT <- file.path(RESULTS_DIR, "SULI_paper_OHC_comparison.jpeg")
