# Script for optimizing only for OHC (using the mse_unc metric)
# Also includes ECS and alpha as params to optimize over
# Uses diffusivity range from Matilda table rather than manuscript script
# Author: Peter Scully
# Date: 6/25/24
...
OUTPUT <- file.path(RESULTS_DIR, "only_OHC.txt")
